...
using std::string;
    ...
    bool rectangleInCircle(int, int, int);
    bool simonSays(vector<int>, vector<int>);
    ...
    vector<vector<int>> squarePatch(int);

    string doubleSwap(string, char, char);
    string uncensor(string, string);
    string rps(string, string);
    string reverse(string);
    string calculateArrowhead(vector<string>);
    string detectWord(string);
